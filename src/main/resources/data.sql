...
insert into recipes(recipe_Id, name, instructions, prep_time, servings, notes, tag, rating, recipe_source, category_name, nutrition_details_Id, shopping_list_id)
values (40001, 'Tomato soup', 'Cut tomatoes and boil the shit out of them', '1 hour', 5, 'Put red unions in there for extra flavour', 'healthy', 7, 'www.soup.com', 'soup', 20001, 30001);

insert into recipes(recipe_Id, name, instructions, prep_time, servings, notes, tag, rating, recipe_source, category_name, nutrition_details_Id, shopping_list_id)
values (40002, 'Frikadellen Fritatta', 'Fritatta de dellen!!', '1 hour', 5, 'Put red unions in there for extra flavour', 'healthy', 7, 'www.soup.com', 'soup', 20002, 30002);

insert into recipes(recipe_Id, name, instructions, prep_time, servings, notes, tag, rating, recipe_source, category_name, nutrition_details_Id, shopping_list_id)
values (40003, 'Groente Ijs', 'spinazie ijs', '1 hour', 5, 'Put red unions in there for extra flavour', 'healthy', 7, 'www.soup.com', 'soup', 20003, 30003);
